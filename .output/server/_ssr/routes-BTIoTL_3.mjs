...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BTIoTL_3.js
...
function buildConstrainedOwnership(mask, width, height, segments, rootOwner = 0) {
	...
	for (let i = 0; i < owner.length; i++) {
		...
		for (let partIndex = 0; partIndex < segments.length; partIndex++) {
			...
			if (projection < (segment.leaf === true ? -.3 : isRoot ? -.15 : .12) || projection > 1.7) continue;
...
var useStudio = create((set, get) => ({
	...
	updateAttachmentMask: (attachmentId, newMask) => set((s) => ({ attachments: s.attachments.map((a) => a.id === attachmentId ? {
		...a,
		mask: newMask,
		repaired: true,
...
function BrushEditor() {
	...
	(0, import_react.useEffect)(() => {
		...
		if (!ctx) return;
		const imgData = new ImageData(new Uint8ClampedArray(attachment.mask.length * 4).map((_, i) => {
	...
	const handlePointerMove = (e) => {
		...
		if (lastPos.current) {
			...
			const steps = Math.ceil(dist / (brush.radius * .5));
			const edits = [];
		...
		children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", {
					...
					children: ["Edit Mask: ", attachment.id]
				}, void 0, true, {
				...
				/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
							onClick: () => setBrush({ enabled: false }),
							children: "Close"
						}, void 0, false, {
							fileName: _jsxFileName$2,
							lineNumber: 112,
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Scissors, { className: "size-4" }, void 0, false, {
				...
				lineNumber: 454,
				columnNumber: 9
			}, this), busy?.includes("Cutting") ? "Cutting paper..." : "Cut paper"]
		}, void 0, true, {
			fileName: _jsxFileName$1,
			lineNumber: 449,
			columnNumber: 7
