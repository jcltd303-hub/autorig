...
import { a as defineLazyEventHandler, d as serve, i as defineHandler, n as HTTPError, o as toEventHandler, r as callMiddleware, s as toMiddleware, t as H3Core, u as NodeResponse } from "./_libs/h3+rou3+srvx.mjs";
...
if (!import.meta.url.includes(".output") && process.argv[1] && (process.argv[1].endsWith("server.ts") || process.argv[1].endsWith("server.js"))) {
	if (!process.env.PORT) process.env.PORT = "3000";
	if (!process.env.HOST) process.env.HOST = "0.0.0.0";
	await import(
		/* @vite-ignore */
		pathToFileURL(resolve(".output/server/index.mjs")).href
);
}
//#endregion
...
var public_assets_data_default = {
	"/favicon.svg": {
		...
		"mtime": "2026-09-17T17:32:49.485Z",
		"size": 430,
	...
	"/__grok/icon-180.png": {
		...
		"mtime": "2026-09-17T17:32:49.484Z",
		"size": 2100,
		"path": "../public/__grok/icon-180.png"
	},
	"/assets/index-sYS9OEwI.js": {
		"type": "text/javascript; charset=utf-8",
		"etag": "\"693d7-XGfIfbuunC1aUmbWYFZhHoc2czE\"",
		"mtime": "2026-09-17T17:32:49.000Z",
		"size": 431063,
		"path": "../public/assets/index-sYS9OEwI.js"
	},
	"/assets/routes-DUsbpedX.js": {
		"type": "text/javascript; charset=utf-8",
		"etag": "\"43392-WEn8eisq4hIbZahpxeC4Z5b3OlY\"",
		"mtime": "2026-09-17T17:32:49.001Z",
		"size": 275346,
		"path": "../public/assets/routes-DUsbpedX.js"
	},
	...
	"/__grok/install/assets/homescreen/ob-ipad.png": {
		...
		"mtime": "2026-09-17T17:32:49.486Z",
		"size": 101843,
	...
	"/assets/styles-Clt6qOg8.css": {
		"type": "text/css; charset=utf-8",
		"etag": "\"bbd5-B0zxdsbKvKCUSbO2DnDlvf2a/a4\"",
		"mtime": "2026-09-17T17:32:49.001Z",
		"size": 48085,
		"path": "../public/assets/styles-Clt6qOg8.css"
	},
...
var findRoute = /* @__PURE__ */ (() => {
	const $0 = {
		route: "/**",
		handler: multiHandler(toEventHandler(server_default), _lazy_0jRgqU)
	};
	return (m, p) => {
		if (p.charCodeAt(p.length - 1) === 47) p = p.slice(0, -1) || "/";
		let s = p.split("/");
