...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DLQzfjxU.mjs");
...
var manifest = {
	"462cf28b778bc6a360ff5f6c317b7727b02a18c86766a0d4c52addb9e86307be": {
		functionName: "conjureFigure_createServerFn_handler",
		importer: () => import("./puppet-ai-C7gXK9SH.mjs")
	},
	"5e685ba558231b0ef858c8f19a474219213c1390f893af741df4d401b3f3be89": {
		functionName: "editFigureImage_createServerFn_handler",
		importer: () => import("./puppet-ai-C7gXK9SH.mjs")
	},
	"9234637ad8fb2b46fe76b02cf7f7a6da3338d782e4dac953cd3ca4bfed99579e": {
		functionName: "composeAnimation_createServerFn_handler",
		importer: () => import("./puppet-ai-C7gXK9SH.mjs")
	},
	"a19ca5e08b5ab708fca8cab79e2c687689dd09bb80d72155b160f3f612d9359e": {
		functionName: "analyzeFigure_createServerFn_handler",
		importer: () => import("./puppet-ai-C7gXK9SH.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DgP_qLAy.mjs").then((n) => n.t),
...
var ROUTER_BASEPATH = "Puppet";
var SERVER_FN_BASE = "/Puppet/_serverFn/";
